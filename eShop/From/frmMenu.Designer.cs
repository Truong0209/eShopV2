namespace eShop.From
{
    partial class frmMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            // menuStrip1
            // 
            menuStrip1.Items.AddRange(new ToolStripItem[] { menuDanhMuc, menuTaiKhoan, adminToolStripMenuItem });
            ...
            // menuTaiKhoan
            // 
            menuTaiKhoan.DropDownItems.AddRange(new ToolStripItem[] { menuDoiMatKhau, menuDangXuat });
            menuTaiKhoan.Name = "menuTaiKhoan";
            menuTaiKhoan.Size = new Size(122, 20);
            menuTaiKhoan.Text = "Thông tin tài khoản";
            // 
            // menuDoiMatKhau
            // 
            ...
            lvGioHang.Columns.AddRange(new ColumnHeader[] { colTenSanPham, colSoLuong, colGia });
